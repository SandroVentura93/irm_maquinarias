...
<div class="container py-4">
    ...
    <form method="GET" class="mb-4" id="form-semanal">
        ...
        <div class="col-md-6">
            <div class="card shadow-sm border-0" style="border-radius:18px; background:#fff;">
                <div class="card-body py-4">
                    <h5 class="card-title text-center mb-3" style="color:#0d9488; font-weight:600; font-size:1.2em;">Resumen Gráfico Semanal</h5>
                    <canvas id="graficoSemanal" height="300"></canvas>
                </div>
            </div>
        </div>
    </div>
    <div class="row mt-4">
        <div class="col-md-12 text-start">
            <a href="/semanal/pdf?year={{ request('year') }}&month={{ request('month') }}&week={{ request('week') }}" class="btn btn-danger me-2" style="font-weight:bold; box-shadow:0 2px 8px #e2e8f0;">
                <i class="fas fa-file-pdf"></i> Exportar PDF
            </a>
            <a href="/semanal/excel?year={{ request('year') }}&month={{ request('month') }}&week={{ request('week') }}" class="btn btn-success" style="font-weight:bold; box-shadow:0 2px 8px #e2e8f0;">
...
const graficoSemanal = new Chart(ctx, {
    ...
    options: {
        ...
        plugins: {
            ...
            title: {
                display: true,
                text: 'Resumen Semanal de Ventas y Compras',
                font: {
                    size: 18,
                    family: 'Inter, Arial, sans-serif',
                    weight: 'bold'
