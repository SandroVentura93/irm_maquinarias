...
<div class="container-fluid">
    ...
    <form action="{{ route('productos.update', $producto) }}" method="POST" id="productForm">
        @csrf
        @method('PUT')
        <div class="row">
            <!-- Información Básica -->
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <small class="text-muted">Creado: {{ $producto->created_at ? $producto->created_at->format('d/m/Y H:i') : 'N/A' }}</small>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="codigo" id="codigo" class="form-control" 
                                           value="{{ old('codigo', $producto->codigo) }}" required placeholder="Ej: PROD001">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="numero_parte" id="numero_parte" class="form-control" 
                                           value="{{ old('numero_parte', $producto->numero_parte) }}" placeholder="Ej: NP-001">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="modelo" id="modelo" class="form-control" 
                                           value="{{ old('modelo', $producto->modelo) }}" placeholder="Modelo del producto">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="peso" id="peso" class="form-control" 
                                           value="{{ old('peso', $producto->peso) }}" placeholder="0.00">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_categoria" id="id_categoria" class="form-control">
                                        ...
                                        @foreach ($categorias as $categoria)
                                            <option value="{{ $categoria->id }}" {{ old('id_categoria', $producto->categoria_id ?? $producto->id_categoria) == $categoria->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_marca" id="id_marca" class="form-control">
                                        ...
                                        @foreach ($marcas as $marca)
                                            <option value="{{ $marca->id }}" {{ old('id_marca', $producto->marca_id ?? $producto->id_marca) == $marca->id ? 'selected' : '' }}>
                                                {{ $marca->descripcion }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_proveedor" id="id_proveedor" class="form-control">
                                        ...
                                        @foreach ($proveedores as $proveedor)
                                            <option value="{{ $proveedor->id }}" {{ old('id_proveedor', $producto->proveedor_id ?? $producto->id_proveedor) == $proveedor->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ubicacion" id="ubicacion" class="form-control" 
                                           value="{{ old('ubicacion', $producto->ubicacion) }}" placeholder="Ej: Almacén A-1">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
            ...
            <div class="col-md-4">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="number" name="stock_actual" id="stock_actual" class="form-control" 
                                   value="{{ old('stock_actual', $producto->stock_actual) }}" required min="0">
                            @if($producto->stock_actual <= $producto->stock_minimo)
                                <small class="text-warning"><i class="fas fa-exclamation-triangle"></i> Stock por debajo del mínimo</small>
                            @endif
                        </div>
                        <div class="form-group">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="precio_compra" id="precio_compra" 
                                   class="form-control" value="{{ old('precio_compra', $producto->precio_compra) }}" required min="0">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="precio_venta" id="precio_venta" 
                                   class="form-control" value="{{ old('precio_venta', $producto->precio_venta) }}" required min="0">
                            <small class="text-muted">≈ $<span id="precio_venta_usd">0.00</span> USD</small>
                        </div>
                        <div class="alert alert-success" id="margen_info">
                            <small><strong>Margen Actual:</strong> <span id="margen_porcentaje">0</span>%</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <a href="{{ route('productos.show', $producto) }}" class="btn btn-info btn-block">
                ...
                <div class="card mt-3">
                    <div class="card-header">
                        <h6 class="mb-0"><i class="fas fa-history"></i> Última Modificación</h6>
                    </div>
                    <div class="card-body">
