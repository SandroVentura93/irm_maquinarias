...
__webpack_require__(/*! ./ui-enhancements */ "./resources/js/ui-enhancements.js");
...
(function () {
  ...
  var ensureStyle = function ensureStyle(id, css) {
  ...
  var initMenu = function initMenu() {
    var menuHeaders = document.querySelectorAll('.menu-item h5');
      ...
      header.addEventListener('click', function () {
        ...
        document.querySelectorAll('.menu-item').forEach(function (item) {
          if (item !== menuItem) {
            ...
            var s = item.querySelector('.submenu');
  ...
  var initHoverEffects = function initHoverEffects() {
    var navLinks = document.querySelectorAll('.nav-link, .submenu a');
  ...
  window.showToast = function (message) {
    ...
    var containerId = 'irm-toast-container';
  ...
  var initAutoCloseAlerts = function initAutoCloseAlerts() {
